...
class SponsorGiftsScreen extends StatefulWidget {
  const SponsorGiftsScreen({super.key});

  @override
  State<SponsorGiftsScreen> createState() => _SponsorGiftsScreenState();
}

class _SponsorGiftsScreenState extends State<SponsorGiftsScreen> {
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(child: Text(giftName, style: const TextStyle(fontSize: 15, color: Colors.white), maxLines: 1, overflow: TextOverflow.ellipsis)),
                      ],
                    ),
                  ),
              ],
